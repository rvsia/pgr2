           ...
           :m_vertexBuffer(QOpenGLBuffer()), m_indicesBuffer(QOpenGLBuffer(QOpenGLBuffer::IndexBuffer))
{
    ...
    static Vertex vertices[] = {
        { {0.0f,      0.0f,      0.0f},{ 1.0, 0.0, 0.0 } },// 0
        { {0.0f+size, 0.0f,      0.0f},{ 0.0, 1.0, 0.0 } },// 1
        { {0.0f+size, 0.0f+size, 0.0f},{ 0.0, 0.0, 1.0 } },// 2
        { {0.0f,      0.0f+size, 0.0f},{ 1.0, 1.0, 0.0 } },// 3
        { {0.0f,      0.0f,      0.0f+size},{ 1.0, 0.0, 0.0 } },// 4
        { {0.0f+size, 0.0f,      0.0f+size},{ 0.0, 1.0, 0.0 } },// 5
        { {0.0f+size, 0.0f+size, 0.0f+size},{ 0.0, 0.0, 1.0 } },// 6
        { {0.0f,      0.0f+size, 0.0f+size},{ 1.0, 1.0, 0.0 } } // 7
    };
