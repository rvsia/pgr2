...
void Scene::init(){
    ...
    m_program->addShaderFromSourceFile(QOpenGLShader::Vertex, ":/shaders/env_vshader.vsh");
    m_program->addShaderFromSourceFile(QOpenGLShader::Fragment, ":/shaders/env_fshader.fsh");
    /// Linkuji shader, to by melo byt udelano pred zaregistrovanim atributu a un. prom.
    m_program->link();
...
void Scene::createSceneContent(){
    ...
    try{
        ...
        std::string url = "/Users/xvsiansk/Desktop/git/603_QML_3dmodel_lib3ds_skybox_env/models/monkey/monkey.3ds";
...
void Scene::paint()
{
    ...
    const qreal retinaScale = 2;// devicePixelRatio();
    ...
    modelViewMatrix.lookAt({0,0,0},{0.3,0.0,-1},{0,1,0});
    ...
    modelViewMatrix.translate(0,-1,-4);
    ...
    m_program->setUniformValue("primaryTexture", 0);
