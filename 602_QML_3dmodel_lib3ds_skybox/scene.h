...
private:
    ...
    GLuint m_skybox_matrixUniform;
    /// Identifikator atributu pozice vrcholu, ktera se posida do shaderu
    GLuint m_skybox_posAttr;
    /// Identifikator atributu textury vrcholu, ktera se posida do shaderu
    GLuint m_skybox_texAttr;
    /// Identifikator prvni textury
    GLuint m_skybox_primaryTexture;

    /// Identifikator projekcni matice, ktera se posida do shaderu
    GLuint m_projectionMatrixUniform;
    /// Identifikator pohledove a modelovaci matice, ktera se posida do shaderu
    ...
    CModel3DS* m_model;
    /// Shader, ktery se pouziva pro vykresleni objektu
    QOpenGLShaderProgram *m_program;
    /// Shader, ktery se pouziva pro vykresleni skyboxu
